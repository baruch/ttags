...
(alias_declaration (alias_initializer . (identifier) @name)) @definition.alias

; Global variable (module level variable)
(module_def (variable_declaration (declarator . (identifier) @name))) @definition.variable
